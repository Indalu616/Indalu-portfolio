  ...
  return (
    <SectionWrapper id="research" ariaLabel="Research">
      ...
      <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2">
        {research.ongoing.map((item) => (
          <Card key={item.title} className="p-6">
            ...
            <h3 className="mt-3 text-base font-semibold text-accent">{item.title}</h3>
      ...
      {research.papers.length > 0 && (
        <>
          <h3 className="mt-16 text-lg font-semibold text-accent">Publications</h3>
      ...
      {research.conferences.length > 0 && (
        <>
          <h3 className="mt-16 text-lg font-semibold text-accent">Conferences</h3>
