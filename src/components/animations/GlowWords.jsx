...
export default function GlowWords({ className }) {
  return (
    ...
    >
      <motion.div
        className="accent-glow absolute h-[380px] w-[380px] rounded-full bg-accent/25 blur-[100px] sm:h-[540px] sm:w-[540px]"
        animate={{ scale: [1, 1.2, 1], opacity: [0.45, 0.8, 0.45] }}
        transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }}
      />
      <motion.div
        className="accent-glow absolute h-56 w-56 rounded-full bg-accent-2/20 blur-[80px] sm:h-72 sm:w-72"
